...
public class LidosLivrosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lidos_livros);
    ...
    protected void onResume() {
        ...
        adapter.clear();
        Livro[] livros = myBooksDb.daoLivro().selecionarLivros("lido");
